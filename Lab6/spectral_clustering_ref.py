...
from kernel_kmeans_ref import capture_current_state, compute_kernel
...
def compute_matrix_u(matrix_w: np.ndarray, cut: int, num_of_clusters: int) -> np.ndarray:
    ...
    # with open("matrix_l_ans.npy", "wb") as f:
    #     np.save(f, matrix_l)
    # exit()
...
def parse_arguments():
    ...
    parser.add_argument('-ione', '--image1', help='First image filename', default='img/image1.png')
    parser.add_argument('-itwo', '--image2', help='Second image filename', default='img/image2.png')
